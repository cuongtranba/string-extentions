...
class TestStringExtentions(unittest.TestCase):
    ...
    def test_snakecase_to_camelcase(self):
        self.assertEqual(StringExtentions.SnakeCaseToCamelCase(
            exampleSnakeCase), "ToCamelCase")

    def test_camelcase_to_snakecase(self):
        self.assertEqual(StringExtentions.CamelCaseToSnakeCase(
            exampleCamelCase), "To_Snake_Case")
